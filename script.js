...
const translations = {
    en: {
        ...
        "features.description": "Discover what makes Reception App the perfect choice for your business",
        "features.speed.title": "Lightning Fast",
        "features.speed.description": "Experience blazing fast performance that keeps your business moving forward without delays.",
        "features.security.title": "Secure & Reliable",
        "features.security.description": "Your data is protected with enterprise-grade security and reliability you can trust.",
        "features.collaboration.title": "Team Collaboration",
        "features.collaboration.description": "Seamlessly collaborate with your team members and boost productivity.",
        "features.analytics.title": "Smart Analytics",
        "features.analytics.description": "Get valuable insights with comprehensive analytics and reporting tools.",
        "features.mobile.title": "Mobile First",
        "features.mobile.description": "Designed for mobile with responsive interface that works everywhere.",
        "features.customization.title": "Customizable",
        "features.customization.description": "Tailor the app to your specific business needs with flexible customization options.",
        "about.title": "About Reception App",
        "about.description": "Reception App is designed to revolutionize how businesses manage their daily operations. Our intuitive mobile app combines powerful features with elegant design to deliver an exceptional user experience.",
        ...
        "privacy.section1.content1": "We collect information you provide directly to us, such as when you create an account, use our services, or contact us for support. This may include your name, email address, phone number, and other contact information.",
        "privacy.section1.content2": "We also automatically collect certain information about your device and how you interact with our app, including device identifiers, IP address, operating system, app usage data, and location information (with your permission).",
        "privacy.section2.title": "How We Use Your Information",
        "privacy.section2.intro": "We use the information we collect to:",
        ...
        "privacy.section2.item4": "Respond to your comments, questions, and customer service requests",
        "privacy.section2.item5": "Monitor and analyze usage patterns and trends",
        "privacy.section2.item6": "Personalize and improve your experience",
        "privacy.section3.title": "Information Sharing",
        "privacy.section3.content1": "We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, except as described in this policy.",
        "privacy.section3.content2": "We may share your information with service providers who assist us in operating our app and conducting our business, provided they agree to keep this information confidential.",
        "privacy.section4.title": "Data Security",
        "privacy.section4.content1": "We implement appropriate technical and organizational security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.",
        "privacy.section4.content2": "However, no method of transmission over the internet or electronic storage is 100% secure, so we cannot guarantee absolute security.",
        "privacy.section5.title": "Your Rights",
        "privacy.section5.content1": "You have the right to access, update, or delete your personal information. You may also opt out of certain communications from us.",
        "privacy.section5.content2": "If you wish to exercise these rights, please contact us using the information provided below.",
        "privacy.section6.title": "Children's Privacy",
        "privacy.section6.content": "Our app is not intended for children under 13 years of age. We do not knowingly collect personal information from children under 13.",
    ...
    ru: {
        ...
        "features.description": "Узнайте, что делает Reception App идеальным выбором для вашего бизнеса",
        "features.speed.title": "Молниеносная скорость",
        "features.speed.description": "Испытайте невероятную производительность, которая не даст вашему бизнесу замедлиться.",
        "features.security.title": "Безопасность и надежность",
        "features.security.description": "Ваши данные защищены корпоративным уровнем безопасности, которому можно доверять.",
        "features.collaboration.title": "Командная работа",
        "features.collaboration.description": "Легко сотрудничайте с членами команды и повышайте продуктивность.",
        "features.analytics.title": "Умная аналитика",
        "features.analytics.description": "Получайте ценную информацию с помощью комплексных инструментов аналитики и отчетности.",
        "features.mobile.title": "Мобильность прежде всего",
        "features.mobile.description": "Разработан для мобильных устройств с адаптивным интерфейсом, который работает везде.",
        "features.customization.title": "Настраиваемый",
        "features.customization.description": "Адаптируйте приложение под конкретные потребности вашего бизнеса с гибкими параметрами настройки.",
        "about.title": "О Reception App",
        "about.description": "Reception App создан для революционного изменения способа управления повседневными операциями бизнеса. Наше интуитивное мобильное приложение сочетает мощные функции с элегантным дизайном для исключительного пользовательского опыта.",
        "about.users": "Активных пользователей",
        "about.uptime": "Время работы",
        ...
        "privacy.section1.content1": "Мы собираем информацию, которую вы предоставляете нам напрямую, например, при создании учетной записи, использовании наших услуг или обращении в службу поддержки. Это может включать ваше имя, адрес электронной почты, номер телефона и другую контактную информацию.",
        "privacy.section1.content2": "Мы также автоматически собираем определенную информацию о вашем устройстве и о том, как вы взаимодействуете с нашим приложением, включая идентификаторы устройства, IP-адрес, операционную систему, данные об использовании приложения и информацию о местоположении (с вашего разрешения).",
        "privacy.section2.title": "Как мы используем вашу информацию",
        "privacy.section2.intro": "Мы используем собираемую информацию для:",
        "privacy.section2.item1": "Предоставления, поддержания и улучшения наших услуг",
        "privacy.section2.item2": "Обработки транзакций и отправки связанной информации",
        "privacy.section2.item3": "Отправки технических уведомлений, обновлений и сообщений поддержки",
        "privacy.section2.item4": "Ответа на ваши комментарии, вопросы и запросы в службу поддержки",
        "privacy.section2.item5": "Мониторинга и анализа моделей и трендов использования",
        "privacy.section2.item6": "Персонализации и улучшения вашего опыта",
        "privacy.section3.title": "Обмен информацией",
        "privacy.section3.content1": "Мы не продаем, не обмениваем и не передаем вашу личную информацию третьим лицам без вашего согласия, за исключением случаев, описанных в этой политике.",
        "privacy.section3.content2": "Мы можем делиться вашей информацией с поставщиками услуг, которые помогают нам в работе нашего приложения и ведении бизнеса, при условии, что они согласятся сохранять эту информацию в тайне.",
        "privacy.section4.title": "Безопасность данных",
        "privacy.section4.content1": "Мы внедряем соответствующие технические и организационные меры безопасности для защиты вашей личной информации от несанкционированного доступа, изменения, раскрытия или уничтожения.",
        "privacy.section4.content2": "Однако ни один метод передачи через интернет или электронного хранения не является на 100% безопасным, поэтому мы не можем гарантировать абсолютную безопасность.",
        "privacy.section5.title": "Ваши права",
        "privacy.section5.content1": "У вас есть право на доступ, обновление или удаление вашей личной информации. Вы также можете отказаться от определенных сообщений от нас.",
        "privacy.section5.content2": "Если вы хотите воспользоваться этими правами, пожалуйста, свяжитесь с нами, используя информацию, предоставленную ниже.",
        "privacy.section6.title": "Конфиденциальность детей",
        "privacy.section6.content": "Наше приложение не предназначено для детей младше 13 лет. Мы не собираем сознательно личную информацию от детей младше 13 лет.",
